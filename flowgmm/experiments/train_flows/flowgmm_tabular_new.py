...
from flow_ssl.data import GAS, HEPMASS, MINIBOONE, SingleCellDataset
...
if __name__=='__main__':
    defaults = makeTrainer.__kwdefaults__
    cfg = argupdated_config(defaults, namespace=(tabular_datasets,flows,archs,trainers))
    # cfg.pop('local_rank')
    print(cfg)
    cfg['bs'] = 5000
    # cfg['ckptdir'] = cfg['logdir']
    # cfg["save_freq"] = 1
    cfg['dataset'] = SingleCellDataset
    cfg['split'] = {'train':-1,'val':.1}
